...
According to the results summarized in Fig. \ref{figure:chatbots_use_gender_age_exp}, teachers mainly use the instant messaging app provided by their institutions (55\%),  and Whatsapp (44\%), the most popular messaging app in Spain. Finally, about 20\% also use Telegram. 
