...
survey.student.interaction <- read.csv("data/survey-student-interaction-pilot-3-2021-EN.csv")
@
...
\begin{center}
    \begin{minipage}[t]{0.3\textwidth}
        \centering
<<gender, echo=FALSE, fig.width=3.2, fig.height=2.2>>=
...
%       \includegraphics[width=\textwidth]{figures/gender.pdf}
    ...
    \begin{minipage}[t]{0.3\textwidth}
        \centering
<<age,echo=FALSE, fig.width=3.2, fig.height=2.2>>=
...
%       \includegraphics[width=\textwidth]{figures/age.pdf}
    ...
    \begin{minipage}[t]{0.3\textwidth}
        \centering
<<sector, echo=FALSE, fig.width=3.2, fig.height=2.2>>=
...
%       \includegraphics[width=\textwidth]{figures/sector.pdf}
    ...
    \begin{minipage}[t]{0.3\textwidth}
        \centering
<<experience,echo=FALSE, fig.width=3.2, fig.height=2.2>>=
...
%       \includegraphics[width=\textwidth]{figures/experience.pdf}
    ...
    \begin{minipage}[t]{0.6\textwidth}
        \centering
<<discipline,echo=FALSE, fig.width=5.75, fig.height=2.2>>=
...
ggplot(survey.pilot, aes(x = Provided, group = Discipline)) + geom_bar(aes(y = ..prop.., fill = factor(..x..)), stat="count", show.legend = FALSE) + scale_y_continuous(labels=scales::percent) + ylab("relative frequencies") + facet_grid(~factor(Discipline, levels=c('Biomedicine','Humanities','Social Sciences','Sciences','Engineering','Technology','No')))+ theme(axis.title.y=element_blank())
@
...
ggplot(survey.pilot, aes(x = WhatsApp, group = Discipline)) + geom_bar(aes(y = ..prop.., fill = factor(..x..)), stat="count", show.legend = FALSE) + scale_y_continuous(labels=scales::percent) + ylab("relative frequencies") + facet_grid(~factor(Discipline, levels=c('Biomedicine','Humanities','Social Sciences','Sciences','Engineering','Technology','No')))+ theme(axis.title.y=element_blank())
@
...
ggplot(survey.pilot, aes(x = Telegram, group = Discipline)) + geom_bar(aes(y = ..prop.., fill = factor(..x..)), stat="count", show.legend = FALSE) + scale_y_continuous(labels=scales::percent) + ylab("relative frequencies") + facet_grid(~factor(Discipline, levels=c('Biomedicine','Humanities','Social Sciences','Sciences','Engineering','Technology','No')))+ theme(axis.title.y=element_blank())
@
...
ggplot(survey.student.interaction, aes(x = Interaction.Synchrony..or.not., group = Experience)) + geom_bar(aes(y = ..prop.., fill = factor(..x..)), stat="count", show.legend = FALSE) + scale_y_continuous(labels=scales::percent) + ylab("relative frequencies") + facet_grid(~Experience) + theme(axis.title.y=element_blank(), axis.title.x=element_blank())
@
