...
Specifically, this survey asked the teachers, in addition to general information (such as gender, age, experience, etc), what are their feelings and preferences with regard to the use of communication tools with students, and even using bots or chatbots in the classroom.
...
% Antonio - I'm not sure about the last one (Synchrony)
