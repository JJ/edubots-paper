...
%Olia - Isn't the following paragraph better fittng for RQ3? What kind interactions do teachers prefer with their students? 
...
The answer, then, to this research question, is that, in general, teachers do {\em not} want to have interaction with students in a chat group.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% RQ4 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
