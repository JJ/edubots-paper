...
A chi-square test of independence was performed to examine the relation between instructors’ discipline, sector, and gender and any potential changes that occurred to the use of messaging apps due to the covid-19 pandemic. The relation between the latter variable and the instructors’ sector was significant, X2 (4, N = 282) = 9.598, p =0.048. The frequencies cross tabulated are given in Table 2. In effect, this finding indicates that how teachers responded to the use of messaging apps during the pandemic and in particular, whether they changed their habits in the use of apps for teaching purposes, was related to their sector (university vs vocational). The relationships between changes in the use of messaging apps, due to the covid-19 pandemic, and the instructors’ discipline, X2 (24, N = 282) = 44.856, p =0.006, as well as the gender, X2 (8, N = 282) = 16.249, p= 0.039 were also significant.  
% Olia - Fran, please also add here tables 1 and 2, as in the attachment that I have sent you. And check for repetitions in the following paragraph that you added. thank you.
...
For answering RQ2, teachers were provided with a list of different potential chatbot functionalities (use cases) and were requested to respond on whether each given use case would be useful in their classes.  The findings are summarized in the table that follows. 
% Fran pleas add table 3 here, as in the attachment I sent you, along with the given caption. 
For the findings it occurs that the most favourable use case for chatbots in Higher Education and vocational training is their use for the facilitation of an agenda formation (171 positive response, 60.6%), followed by the FAQs use case (148 positive responses, 52.5%) and the sharing class material use case (136; 48.2%). A chi-square test of independence was performed to examine the relation among participants’ preferences for particular chatbot use cases. The relation between agenda and the FAQs use case was significant, X2 (1, N = 282) = 10.467, p =0.001. The frequencies cross tabulated are given in Table 4. Out of the 171 teachers who consider useful the use of chatbots for agenda preparation in the class, 103 also consider useful chatbots’ use for FAQs.  
% Fran pleas add table 4 here, as in the attachment I sent you, along with the given caption. 
...
For answering RQ3, teachers were provided with a list of different kind of interactions that may take place among students and between students and the teacher, with the use of messaging apps. The findings are summarized in the table that follows. 
% Fran please add table 5, as per attachment, along with the given caption.  
...
% Fran, please add table 6 here, as per attachment, along with the given caption.  
...
A chi-square test of independence was performed to examine the potential relationship among the various features. The statistically significant correlations are given in the table that follows.  
% Fran, please add table 7 here, as per attachment, along with the given caption. 
...
\end{itemize}
% TODO A chi-square test of independence was performed to examine the potential relationship among the various features. The statistically significant correlations are given in the table that follows. 
