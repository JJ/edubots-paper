...
experiences and group discussions \cite{panah2020study}. WhatsApp is
...
in using this technology in classes. Indeed, the use of chatbots in
...
questions about enrolment and registration. Ask
...
Furthermore, \cite{sjostrom2018designing} proposed a conceptual
architecture for teaching-oriented chatbots in higher education.  This
