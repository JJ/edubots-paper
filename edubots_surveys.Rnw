...
\begin{itemize}
\item{ RQ1 - Are teachers willing to use chatbots in their classes? }
...
\subsection{RQ1 - Are teachers usings chatbots in their classes?}
...
\label{figure:chatbots_use_gender_age}
\end{figure} 
...
\end{center}
    \caption{XXXX}
\label{figure:chatbots_use_sector_discip_exp}
\end{figure} 
