...
As in any new technology, it's important to ascertain which factors will help or impede its adoption; this is why many studies have focused on the evaluation of technology
...
This is why this paper is focused on which factors are considered the most important by the people that are going to use them. We spread our survey over university as well as other higher education institution, so that we find out if there's any kind of difference between long-cycle, degree oriented institutions (universities) and vocational/professionally oriented institutions (elsewhere known as "polytechnics" or "vocational training" institutions, in Spain known as high schools).
