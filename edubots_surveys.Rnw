...
gender, experience, and other factors, such as the type of discipline
...
13 & OtherBot		\\
14 & Sector		\\
15 & Messaging Organization → Number of approaches considered		\\
16 & Degrees → Number of degrees involved		\\
17 & Discipline		\\
\hline
Output & PostCOVID changes	\\
\hline
\end{tabular} \label{tab:feature_reference} \caption{Mapping of feature numbers to survey questions.}
\end{table}
