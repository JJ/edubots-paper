...
Introducing new technologies such as messaging platforms, and chatbots attached to it, in higher education, requires careful consideration of all options, but above all, an examination of the attitudes of the affected community. 
% Antonio - En realidad, la comunidad afectada incluiría también a los estudiates, ¿no?
% Por cierto, quizá también se podrían incluir aqui las encuestas pasadas a los estudiantes. No son las mismas preguntas, pero van en una línea similar. Quizá tuviesen cabida y le darían 
% más enjundia al estudio. ;)
...
% customized en lugar de personalized? Por no repetir personalized dos veces en la misma frase
...
Given the potential advantages that chatbots could bring to the classroom, as a previous step, we have performed a survey to 300 teachers asking about their attitudes towards the use of chatbots in their classes. We analyse in this work their responses, since we are interested in discussing implications and the impact for the development of future technology-enhanced tools and the Education institutions policies regarding the following research questions:
\begin{itemize}
