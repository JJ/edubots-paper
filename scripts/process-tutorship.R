...
ggsave('../figures/gender_synch.pdf', width = 100, height = 70, units = "mm")
...
ggsave('../figures/age_synch.pdf', width = 100, height = 70, units = "mm")
...
ggsave('../figures/experience_synch.pdf', width = 100, height = 70, units = "mm")
...
ggsave('../figures/discipline_synch.pdf', width = 186, height = 77, units = "mm")
